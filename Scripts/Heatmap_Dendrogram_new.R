Heatmap_Dendrogram_new <- function () {
  ...
  ImpF <- read.csv("D:/Data/R_clusters/No_BMN673_dend.csv")
  ...
  #export to PDF
  pdf("D:/Data/R_clusters/heatmap_dendrogram.pdf", width=15, height=15)
  ...
  heatmap.2(as.matrix ( newVar ), trace='none', breaks=c(seq(0,0.5,0.0005), seq(0.51,1.5,0.008), seq(1.51, 2.94, 0.015) ), col=my_palette, dendrogram='col', Rowv=rev(as.dendrogram(dv)), Colv= as.dendrogram(dv),labRow = ImpF$STAY.dev,cexRow = 0.6, cexCol = 0.6, labCol = ImpF$STAY.dev , main='Dendrogram and Heatmap' )
