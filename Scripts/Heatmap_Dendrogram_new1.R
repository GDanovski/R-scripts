Heatmap_Dendrogram_new <- function () {
  ...
  #export to PDF
  pdf("D:/Data/R_clusters/heatmap_dendrogram1.pdf", width=15, height=15)
  ...
  heatmap.2(as.matrix ( newVar ), trace='none', breaks=c(seq(0,1.0,0.01),  seq(1.01, 2.94, 0.02) ), col=my_palette, dendrogram='col', Rowv=rev(as.dendrogram(dv)), Colv= as.dendrogram(dv),labRow = ImpF$STAY.dev,cexRow = 0.6, cexCol = 0.6, labCol = ImpF$STAY.dev , main='Dendrogram and Heatmap' )
