Heatmap_Dendrogram <- 
  ...
  #export to PDF
  pdf("D:/Data/R_clusters/dendrogram.pdf", width=15, height=15)
  ...
  #export to PDF
  pdf("D:/Data/R_clusters/heatmap.pdf", width=15, height=15)
  ...
  heatmap.2(as.matrix ( newVar ),trace='none', breaks=c(seq(0,0.5,0.0005), seq(0.51,1.5,0.008), seq(1.51, 2.94, 0.015) ), col=my_palette, dendrogram='none', Rowv=FALSE, Colv=FALSE, main='Pure Heatmap' )
